...
public class CadastroProdutoController implements Initializable {
	...
	private Produto getProdutoData() {
		...
		if(txtEstoqueMinimo.getText() == null || txtEstoqueMinimo.getText().trim().equals("")) {
			exception.addError("estoqueMin", "Estabeleça uma quantidade m�nima desse produto no estoque para controle");
		}
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		errorEstoqueAtual.setText("Caso possua esse produto em estoque, informe a quantidade. Caso contrário, quantidade deve ser 0");
	}
}
