...
public class OrdemServicoEmpresaVisualizarController implements DataChangeListener, Initializable {
	...
	public void onBtBuscarAction() {
		...
		if(txtBuscarCodOrdem == null || txtBuscarCodOrdem.getText().equals("")) {
			Alerts.showAlert("Erro ao buscar", null, "Campo de busca não pode estar vazio. Insira o número da ordem de serviço", AlertType.INFORMATION);
		}
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		initEditButtons();
		initRemoveButtons();
		txtBuscarCodOrdem.setPromptText("Insira Nº da ordem de serviço");
	}
	...
	private void excluirOrdemServicoEmpresa(OrdemServicoEmpresa obj) {
		...
		if (result.get() == ButtonType.OK) {
			if (ordemServicoEmpresaService == null) {
				throw new IllegalStateException("Ordem de serviço vazio");
			}
			try {
