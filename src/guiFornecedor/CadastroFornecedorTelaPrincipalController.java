...
public class CadastroFornecedorTelaPrincipalController implements Initializable {
	...
	public void onBtCadastrarAction(ActionEvent event) {
		...
		try {
			...
			loadClienteVisualizar("/guiFornecedor/FornecedorVisualizar.fxml",
	...
	private Fornecedor getFornecedorData() {
		...
		if (txtAtividadeFim.getText() == null || txtAtividadeFim.getText().trim().equals("")) {
			exception.addError("atividadeFim", "Insira um ramo de atua��o para esta fornecedor");
		}
